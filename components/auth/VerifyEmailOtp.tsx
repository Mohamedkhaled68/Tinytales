...
export default function VerifyEmailOtp() {
    ...
    const { verifyUserEmail, resendVerificationCode, isLoading } = useAuth();
    ...
    const handleVerify = async () => {
        ...
        try {
            await verifyUserEmail(fullCode, lang);
    ...
    useEffect(() => {
        const calculateCountdown = () => {
            const expiryTime = localStorage.getItem("otp_expiry_time");
            if (!expiryTime) {
