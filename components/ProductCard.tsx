        ...
        <>
            <div className="flex flex-col gap-2 w-43">
                ...
                <div className="rounded-[20px] border border-black/5 flex flex-col gap-4 overflow-hidden p-3">
                    ...
                    <div className="relative w-full h-34.25">
                        <Image
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <h1 className="font-poppins-medium font-medium text-[10px] text-tiny-black">
                        J.VER Women's Dress Shirts Solid Long Sleeve Stretch
                        Wrinkle-Free With Yello ..
                    </h1>
                    <div className="flex items-center gap-2">
                        <span className="font-poppins-medium font-medium text-sm text-tiny-black">
                            AED 900
                        </span>
                        <span className="font-poppins-medium font-medium text-xs text-tiny-black-200 line-through">
                            AED 1300
                        </span>
                    </div>
